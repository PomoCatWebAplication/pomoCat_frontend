...
type Props = { catSrc: string, coins_user: string };

export default function HomeClient({ catSrc, coins_user }: Props) {
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <nav className={styles.navigator}>
          <Link href="/pages/home"><Image src="/icons/home.svg" alt="home" width={100} height={100} className={styles.icon}/></Link>
          <Link href="/pages/calendar"><Image src="/icons/calendar-regular-full.svg" alt="calendar" width={5} height={5} className={styles.icon}/></Link>
          <Link href="/pages/shop"><Image src="/icons/shopping-cart.svg" alt="shop" width={5} height={5} className={styles.icon}/></Link>
          <Link href="/pages/settings"><Image src="/icons/settings.svg" alt="settings" width={5} height={5} className={styles.icon}/></Link>
        </nav>
      </header>
        ...
        <div className={styles.card}>
          <div className={styles.controller}>
            <div className={styles.timmers}>
              ...
              <div className={styles.inside_timmers}>
          ...
          <div id="settings-panel" className={`${styles.insideSettings} ${visible ? styles.open : ""}`}>
            ...
            <div className={styles.settingsControl}>
              <MinutesSlider min={1} max={120} step={1} defaultValue={30}/>
              <MinutesSlider min={1} max={120} step={1} defaultValue={15} label="descanso"/>
            </div>

            <div className={styles.buttonSettings}>
              <button className={styles.settingsBtn}>
                <Image src="/icons/play-solid-full.svg" alt="Play_with_settings" width={20} height={20}/>
              </button>
            </div>
          </div>
        </div>
